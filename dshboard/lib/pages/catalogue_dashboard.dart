...
class CatalogueDashboard extends StatefulWidget {
  const CatalogueDashboard({super.key});

  @override
  State<CatalogueDashboard> createState() => _CatalogueDashboardState();
}

class _CatalogueDashboardState extends State<CatalogueDashboard> {
