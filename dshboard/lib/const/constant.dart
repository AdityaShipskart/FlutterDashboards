...
class DashboardColors {
  // Platinum Subscribers (Green Theme)
  static const Color platinumIcon = Color(0xFF059669);
  static const Color platinumBg = Color(0xFFDCFCE7);

  // Gold Subscribers (Orange Theme)
  static const Color goldIcon = Color(0xFFD97906);
  static const Color goldBg = Color(0xFFFEF3C7);

  // Free Subscribers (Gray Theme)
  static const Color freeIcon = Color(0xFF374151);
  static const Color freeBg = Color(0xFFF3F4F6);

  // Expiring Soon (Red Theme)
  static const Color expiringIcon = Color(0xFFDC2626);
  static const Color expiringBg = Color(0xFFFEE2E2);

  // Growth indicator color
  static const Color growthBg = Color(0xFF059669);
}
